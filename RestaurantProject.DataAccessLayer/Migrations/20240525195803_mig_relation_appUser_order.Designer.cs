...
namespace RestaurantProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20240525195803_mig_relation_appUser_order")]
    partial class mig_relation_appUser_order
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.About", b =>
                {
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.Basket", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("RestaurantProject.EntityLayer.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("RestaurantProject.EntityLayer.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.Basket", b =>
                {
                    b.HasOne("RestaurantProject.EntityLayer.Entities.MenuTable", "MenuTable")
                        .WithMany("Baskets")
                        .HasForeignKey("MenuTableID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestaurantProject.EntityLayer.Entities.Product", "Product")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.Order", b =>
                {
                    b.HasOne("RestaurantProject.EntityLayer.Entities.AppUser", "AppUser")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.OrderDetail", b =>
                {
                    b.HasOne("RestaurantProject.EntityLayer.Entities.Order", "Order")
            ...
            modelBuilder.Entity("RestaurantProject.EntityLayer.Entities.Product", b =>
                {
                    b.HasOne("RestaurantProject.EntityLayer.Entities.Category", "Category")
                        .WithMany("Products")
